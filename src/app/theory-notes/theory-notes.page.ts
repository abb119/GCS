...
@Component({
  selector: 'app-theory-notes',
  templateUrl: './theory-notes.page.html',
  styleUrls: ['./theory-notes.page.scss'],
  standalone: false
})
export class TheoryNotesPage implements OnInit {
  subjectId: string = '';
  notes: Note[] = [];
  filteredNotes: Note[] = [];
  ...
  loadNotes() {
    ...
    this.notesService.getTheoryNotes().subscribe({
  ...
  loadBackupNotes() {
    ...
    const backupNotes: Note[] = [
      ...
      {
        "id": "2",
        "title": "Resumen tema 2",
        "description": "Bucles, condicionales y estructuras de control.",
        "subjectId": "P1",
        "date": "2025-06-02"
      }
    ];
